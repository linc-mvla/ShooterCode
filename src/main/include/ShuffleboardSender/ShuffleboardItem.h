...
class BasicShuffleboardItem : public ShuffleboardItemInterface{
    public:
        BasicShuffleboardItem(ItemData data):ShuffleboardItemInterface(data){};
...
template <typename T>
class ShuffleboardItem : public BasicShuffleboardItem{
    public:
