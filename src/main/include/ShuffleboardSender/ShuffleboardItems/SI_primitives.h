...
template<> class ShuffleboardItem<double> : public BasicShuffleboardItem{
    public:
...
template<> class ShuffleboardItem<bool>: public BasicShuffleboardItem{
    public:
...
template<> class ShuffleboardItem<int>: public BasicShuffleboardItem{
    public:
